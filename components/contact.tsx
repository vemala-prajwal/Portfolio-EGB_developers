        ...
        <div className="grid gap-16 lg:grid-cols-2">
          <ScrollReveal>
            ...
            <div className="mt-10 space-y-4 text-sm">
              <a href={`mailto:${contact.email}`} className="link-premium block text-white">
                {contact.email}
              </a>
              <a href={`tel:${contact.phone.replace(/\s/g, '')}`} className="link-premium block text-muted">
                {contact.phone}
              </a>
            </div>
            ...
            <div className="surface-card rounded-2xl p-8 lg:p-10">
              <AnimatePresence mode="wait">
                {submitted ? (
                  ...
                  <motion.form key="form" onSubmit={handleSubmit} className="space-y-5" data-lenis-prevent>
